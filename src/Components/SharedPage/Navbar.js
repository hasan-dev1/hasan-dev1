...
const Navbar = () => {
    ...
    const navbarItem = [
        ...
        <li className='mx-1' key={4}><a className={'hover:bg-slate-700 rounded py-2 px-4'} href="#project">Projects</a></li>,
        <li className='mx-1' key={3}><a className={'hover:bg-slate-700 rounded py-2 px-4'} href="#hireme">Contuct Me</a></li>,
